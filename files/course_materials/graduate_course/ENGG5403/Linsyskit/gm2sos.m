function [gm2s,P,Q] = gm2sos(A,B,E,C1,D1,C2,D2,tol)
%
% [gm2s,P,Q] = gm2sos(A,B,E,C1,D1,C2,D2,tol)
%
...
%
% P and Q are the solutions to the corresponding Riccati equations.
%
% See also gm2star and gm8sos.
